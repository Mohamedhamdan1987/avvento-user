...
class ClientWalletPage extends StatelessWidget {
      ...
      child: Column(
        children: [
          ...
          _buildActionButton(
            ...
            onTap: () => _showDepositDialog(controller),
          ),
        ],
      ),
    );
  ...
  void _showDepositDialog(ClientWalletController controller) {
    ...
    Get.dialog(
      AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: () => Get.back(),
            child: const Text('إلغاء', style: TextStyle(color: AppColors.textMedium)),
          ),
          ElevatedButton(
            onPressed: () {
